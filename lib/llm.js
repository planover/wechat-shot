...
function isBlockedHostname(host) {
  ...
  if (h === 'localhost' || h.endsWith('.localhost') || h === 'metadata' || h.endsWith('.metadata') || h === 'internal' || h.endsWith('.internal')) return true;
  // 字面量 IPv4 段
...
module.exports = { generateChatViaLLM, assertSafeBaseUrl, buildSystemPrompt, escapeHtml, sanitizeLLMOutput, applyComplianceFilter, COMPLIANCE_BLOCKLIST };
